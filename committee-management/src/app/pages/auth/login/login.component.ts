...
<div class="auth-wrap" [attr.data-theme]="'dark'">
  ...
  styles: [`
    ...
    .auth-sub { color: rgba(240,244,255,0.55); font-size: .9rem; margin-bottom: 1.8rem; line-height: 1.65; }
    ...
    h2 { font-size: 1.5rem; font-weight: 700; color: #f0f4ff; text-align: center; margin-bottom: .3rem; }
    .auth-card-sub { font-size: .83rem; color: rgba(240,244,255,0.5); text-align: center; margin-bottom: 1.6rem; }
    .auth-form { display: flex; flex-direction: column; gap: 1rem; }
    .fg { display: flex; flex-direction: column; gap: .38rem; }
    .fg label { font-size: .78rem; font-weight: 600; color: rgba(240,244,255,0.7); }
    ...
    .finp { width: 100%; background: rgba(255,255,255,0.05); border: 1px solid rgba(255,255,255,0.1); border-radius: 8px; padding: .62rem .85rem .62rem 2.4rem; color: #f0f4ff; font-family: inherit; font-size: .875rem; outline: none; transition: border-color .2s; &:focus { border-color: rgba(45,140,255,0.5); } &::placeholder { color: rgba(240,244,255,0.2); } &.err { border-color: rgba(239,68,68,0.5); } }
    ...
    .auth-btn { width: 100%; display: flex; align-items: center; justify-content: center; gap: 7px; padding: .75rem; background: #2d8cff; color: #fff; border: none; border-radius: 8px; font-family: inherit; font-size: .9rem; font-weight: 600; cursor: pointer; transition: all .2s; margin-top: .25rem; .material-icons { font-size: 18px; } &:hover:not(:disabled) { opacity: .85; transform: translateY(-1px); } &:disabled { opacity: .6; cursor: not-allowed; } }
    ...
    .auth-card-foot { text-align: center; margin-top: 1.4rem; padding-top: 1.2rem; border-top: 1px solid rgba(255,255,255,0.06); p { font-size: .82rem; color: rgba(240,244,255,0.45); margin-bottom: .6rem; a { color: #2d8cff; font-weight: 600; text-decoration: none; &:hover { text-decoration: underline; } } } }
